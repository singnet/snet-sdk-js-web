...
const Model = ({ model, trainingProvider, getAllModels }) => {
    ...
    const validateModel = async (model) => {
        ...
        const validatedModel = await trainingProvider.validateModel(params);
    ...
    const trainModel = async (model) => {
        ...
        const validatedModel = await trainingProvider.trainModel(params);
        console.log("validatedModel: ", validatedModel);
        } catch (err) {
